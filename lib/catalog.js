...
const CATALOG = {
  ...
  "mobile-numerology-webinar-fb": {
    name: "Mobile Numerology Webinar FB",
    description: "Full numerology analysis with yearly forecast",
    amount: 100, // Rs.1
    currency: "INR",
    thankyou_path: "/insfb-ty/",
    pabbly_webhook: "https://connect.pabbly.com/workflow/sendwebhookdata/IjU3NjcwNTZlMDYzNzA0MzM1MjZiNTUzNTUxMzMi_pc",
  },
